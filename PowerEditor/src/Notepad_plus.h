...
// end fileOperations
   ...
   LocaInSituDlg _LocaInSituDlg;
   bool ReloadStringInUI(ResType resType, HWND hDlg, const string& dlgTagName);
   bool ChangeString(ResType resType, const string& dlgTagName, UINT uItemID, string& sNewTranslation);
   bool GetAllTranslation(ResType resType, const string& dlgTagName, UINT uItemID, std::vector<string> & ListString);
   bool GetSourceName(ResType resType, const string& dlgTagName, UINT uItemID, string& sSourceName);
   bool SetSourceName(ResType resType, const string& dlgTagName, UINT uItemID, const string& sSourceName);

private:
   static Notepad_plus* _Singleton;
